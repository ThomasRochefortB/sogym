...
class sogym(gym.Env):
    ...
    def __init__(self,N_components=8,resolution = 100, observation_type = 'dense',mode = 'train',img_format='CHW',seed=None,vol_constraint_type='hard',model=None,tokenizer=None):
